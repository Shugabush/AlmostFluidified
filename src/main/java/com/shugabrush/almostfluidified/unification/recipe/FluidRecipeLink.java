package com.shugabrush.almostfluidified.unification.recipe;
...
public final class FluidRecipeLink
{
    ...
    public static FluidRecipeLink of(ResourceLocation id, JsonObject originalRecipe)
    {
        ...
        {
            AlmostFluidified.LOGGER.warn("Could not detect recipe type for recipe '{}', skipping.", id);
            return null;
        }
    }
    ...
    private Fluid getCraftingRecipeOutput()
    {
        if (craftingRecipeOutput == null)
        {
            ...
            {
                AlmostFluidified.LOGGER.warn("Could not detect crafting recipe output for recipe '{}'.", id);
