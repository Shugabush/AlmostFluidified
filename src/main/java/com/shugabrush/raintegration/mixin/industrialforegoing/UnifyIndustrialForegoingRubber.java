...
public class UnifyIndustrialForegoingRubber {
    ...
    @ModifyArg(method = "lambda$onFinish$2", at = @At(value = "INVOKE", target = "Lnet/minecraftforge/items/ItemHandlerHelper;insertItem(Lnet/minecraftforge/items/IItemHandler;Lnet/minecraft/world/item/ItemStack;Z)Lnet/minecraft/world/item/ItemStack;"), index = 1)
    private @NotNull ItemStack v(@NotNull ItemStack originalItem) {
        ...
        return new ItemStack(ItemUnification.getItem(map.getReplacementForItem(new ResourceLocation("industrialforegoing", "dryrubber"))));
    }
}
