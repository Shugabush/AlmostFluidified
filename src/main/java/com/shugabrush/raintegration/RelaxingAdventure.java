...
@Mod(RelaxingAdventure.MOD_ID)
@SuppressWarnings("removal")
public class RelaxingAdventure {

    public static final String MOD_ID = "raintegration";
    public static final Logger LOGGER = LogManager.getLogger();
    public static GTRegistrate EXAMPLE_REGISTRATE = GTRegistrate.create(RelaxingAdventure.MOD_ID);

    public RelaxingAdventure() {
    ...
    private void addMaterialRegistries(MaterialRegistryEvent event) {
        GTCEuAPI.materialManager.createRegistry(RelaxingAdventure.MOD_ID);
    }
